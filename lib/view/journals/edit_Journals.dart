...
class EditJournal extends StatefulWidget {
  const EditJournal({Key? key, required this.journalModel}) : super(key: key);
...
class _EditJournalState extends State<EditJournal> {
  ...
  void initState() {
    ...
    title.text = widget.journalModel.title;
    admirerList.addAll(widget.journalModel.admirers);
    pickerColor = Color(widget.journalModel.color);
    getLogedInUser();
...
// ValueChanged<Color> callback
  ...
  dataStore() async{
    ...
    controller.getText().then((value)async{
      ...
      boxes.put("${widget.journalModel.id}", data).then((value) {
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: AppButton(
                          ...
                          onClick: (){
                            controller.insertHtml(widget.journalModel.details);
                            Navigator.pop(context);
                          }
                      ),
                    ),
